...
export const RUNEWORDS = [
...

  {
    ...
    runes: [3, 8],
    types: [ItemTypes.ITEM_TYPE_STAVES],
...

  {
    ...
    runes: [5, 8, 9, 7],
    types: [ItemTypes.ITEM_TYPE_SCEPTERS],
    excluded: "",
    level: 21,
    ladder: false,
    stats: {
...

  {
    ...
    runes: [11, 8, 10],
    types: [ItemTypes.ITEM_TYPE_SWORDS, ItemTypes.ITEM_TYPE_SCEPTERS],
    excluded: "",
    classes: [],
    patch: "",
    level: 25,
...

  {
    ...
    runes: [7, 10, 9, 11],
    types: [ItemTypes.ITEM_TYPE_SWORDS, ItemTypes.ITEM_TYPE_SHIELDS],
    excluded: "",
    classes: [],
    patch: "1.10",
    level: 25,
...

  {
    ...
    runes: [8, 3, 7, 12],
    types: [
      ItemTypes.ITEM_TYPE_MISSILE_WEAPONS,
      ItemTypes.ITEM_TYPE_POLEARMS,
      ItemTypes.ITEM_TYPE_STAVES,
    ],
    excluded: "Not Spears",
    classes: [],
    patch: "1.10",
...

  {
    ...
    runes: [14, 16],
    types: [ItemTypes.ITEM_TYPE_WANDS],
    excluded: "",
    classes: ["Necromancer"],
    patch: "",
    level: 35,
  ...
  /**
   * Hustle (id 33) — блок оружия сверен со скрином вики/UI (март 2026).
   * ED 200–240; порядок: аура Fanaticism → Burst → IAS → ED → Dex → урон/AR по нежити. Броня — отдельный набор.
   */
  {
    id: 33,
    name: {
    ...
    runes: [13, 18, 2],
    types: [ItemTypes.ITEM_TYPE_WEAPONS, ItemTypes.ITEM_TYPE_BODY_ARMORS],
    excluded: "",
    classes: [],
    patch: "2.6",
    level: 39,
    ...
    stats: {
      ru: [
        ...
        "+30% к скорости атаки",
        "+<span class='varies'>200-240</span>% к урону",
        "+10 к ловкости",
        "+75% урона по нежити",
      ...
      en: [
        ...
        "+<span class='varies'>200-240</span>% Enhanced Damage (varies)",
        "+10 To Dexterity",
        "+75% To Damage to Undead",
  ...
  /**
   * Crescent Moon (id 44) — сверено со скрином вики/UI (март 2026).
   * Руны Shael–Um–Tir, ур. 47, топоры / мечи / древковое. Сопротивление молнии врага −25% (не −35%); порядок как на скрине.
   */
  {
    id: 44,
    name: {
    ...
    stats: {
      ru: [
        ...
        "-25% к сопротивлению молнии у врага",
        "+<span class='varies'>9-11</span> к поглощению магического урона",
      ...
      en: [
        ...
        "+<span class='varies'>9-11</span> To Magic Absorb (varies)",
...

  {
    ...
    runes: [18, 26, 21, 10],
    types: [ItemTypes.ITEM_TYPE_STAVES, ItemTypes.ITEM_TYPE_MACES],
    excluded: "",
    classes: [],
    patch: "1.10",
    level: 55,
...

  {
    ...
    runes: [26, 27, 24, 14],
    types: [ItemTypes.ITEM_TYPE_PALADIN_SHIELDS],
    excluded: "",
    classes: ["Paladin"],
    patch: "1.10",
    level: 57,
...

  {
    ...
    runes: [29, 28, 12],
    types: [ItemTypes.ITEM_TYPE_BODY_ARMORS, ItemTypes.ITEM_TYPE_SHIELDS],
    excluded: "",
    patch: "1.10",
    level: 61,
    ladder: false,
...

  {
    ...
    runes: [16, 31, 21],
    types: [ItemTypes.ITEM_TYPE_HELMS, ItemTypes.ITEM_TYPE_SHIELDS],
    excluded: "",
    patch: "1.10",
    level: 65,
    ladder: false,
...

  {
    ...
    types: [
      ItemTypes.ITEM_TYPE_SWORDS,
      ItemTypes.ITEM_TYPE_CLAWS,
      ItemTypes.ITEM_TYPE_DAGGERS,
    ],
    excluded: "",
    patch: "2.4",
    level: 67,
